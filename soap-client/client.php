...
{	private $host="localhost";	
	...
	*/
	...
	{	// set uri SOAP server
		...
		$this->options = array('location' => 'http://127.0.0.1:8080/soap/soap-server/server.php','uri' => 'http://127.0.0.1:8080');
	...
	public function tambah_mhs($nim_mhs,$nama_mhs,$alamat_mhs,$no_telp_mhs)
	{	// memanggil method/fungsi yang ada di server
		$this->api->tambah_mahasiswa($nim_mhs,$nama_mhs,$alamat_mhs,$no_telp_mhs);
	...
	public function ubah_mhs($nim_mhs,$nama_mhs,$alamat_mhs,$no_telp_mhs)
	{	// memanggil method/fungsi yang ada di server
		$this->api->ubah_mahasiswa($nim_mhs,$nama_mhs,$alamat_mhs,$no_telp_mhs);
	...
	{	// query ke lokal database client
		...
		{	// query ke lokal database client
			...
			$query->execute(array($r['nim'],$r['nama'],$r['alamat'],$r['no_telp']));	
