...
<legend>Tambah Data</legend>	
	...
	<form class="form-horizontal" name="form1" method="POST" action="proses.php" novalidate>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="no_telp" class="input-medium" placeholder="No Telp Mahasiswa"
					rel="tooltip" data-placement="right" title="Masukkan No Telp Mahasiswa"
					required data-validation-required-message="Harus diisi">
			</div>
		</div>
		<div class="control-group">
...
<legend>Ubah Data</legend>	
	<form name="form1" method="post" action="proses.php" class="form-inline">
		...
		<input type="text" name="nama_mhs" class="input-medium" placeholder="Nama Mahasiswa" value="<?=$r['nama']?>">
		<input type="text" name="alamat" class="input-medium" placeholder="Alamat Mahasiswa" value="<?=$r['alamat']?>">
		<input type="text" name="no_telp" class="input-medium" placeholder="No Telp Mahasiswa" value="<?=$r['no_telp']?>">
...
<legend>Daftar Data Server</legend>
	...
	?>	<tr><td><?=$no?></td>
			...
			<td><?=$r['alamat']?></td>
			<td><?=$r['no_telp']?></td>
			<td><a href="?page=ubah-data&nim=<?=$r['nim']?>" role="button" class="btn btn-success"><i class="icon-pencil"></i></a></td>
